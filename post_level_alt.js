...
function genModalInner() {
	...
	<table>
		<tr>
			...
			<td>
				<h3>Trust, but verify</h3><p>This text was generated by an algorithm that has no human sense of race, gender, disability status, or names. It also makes things up. Please read the resulting text and make sure it is something that is true and that respects the subject.</p>
			</td>
		</tr>
		<tr>
			<td>
